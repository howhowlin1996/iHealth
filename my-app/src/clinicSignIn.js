import {
  ...
  async function signIn(inform){
    let result= await api.clinicSignIn(inform);
          ...
          <Box
            ...
            <Stack spacing={4}>
              <FormControl id="email">
                ...
                <Input type="email" onChange={(e)=>{inform.email=e.target.value}}/>
              </FormControl>
              <FormControl id="password">
                <FormLabel>密碼</FormLabel>
                <Input type="password" onChange={(e)=>{inform.password=e.target.value}}/>
              </FormControl>
              <Stack spacing={10}>
                <Stack
